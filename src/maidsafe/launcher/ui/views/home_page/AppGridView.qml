...
ScrollView {
  ...
  Item {
    ...
    height: gridView.height + gridView.anchors.topMargin + gridView.anchors.bottomMargin
    ...
    Item {
      ...
      y: detailsBox.item ? detailsBox.item.y + gridView.rowHeight + gridView.anchors.topMargin : 0
